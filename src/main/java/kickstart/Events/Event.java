...
public class Event implements CartItem{
    ...
    public String getVisitorsQuantity() { return visitorsQuantity; }
    ...
    public void setVisitorsQuantity(String visitorsQuantity) { this.visitorsQuantity = visitorsQuantity; }
