...
| Actor                            | Customer and Admin
| Essential Steps                 a| 
1. The Customer/Admin presses the button „Orders“ in the navigation bar
2. The Customer will get an overview about his bookings of stalls with equipment. The Admin will get a overview of all Orders for an event.
