...
| There should be a button on the booking list to add equipment for the booked sale stand. If finished, he can press the button and the equipment will be added to the stand.
